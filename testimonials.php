...
<body>
  ...
  <section class="testimonial-heading-page header-text" id="top">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-8 " style="color:white;">
                        ...
                        <h2 >Training Testimonials</h2>
                            ...
                            <p style="color:white;">Credit... is the only enduring testimonial to man's confidence in man. ~James Blish</p>
                            <hr>
                            <br>
                            <br>
                            <p style="color:white;"><b>Although our software courses are designed to be easy to learn, our students often tell us that the training they take advantage of enhances their experience using our software training delivery and their overall efficiency.</b></p>
                            <br>
