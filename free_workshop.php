...
include('includes/configure.php');
    if(isset($_POST['submit']))
    {
        ...
        if (mysqli_query($conn, $query)){
          echo "<script> alert ('New record has been added successfully !');window.location='free_workshop.php'</script>";
       } else {
...
<body>
              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <ul class="nav">
                          ...
                          <li class="has-sub">
                              <a href="javascript:void(0)" class="active">New Batches</a>
                              <ul class="sub-menu">
                                  <li><a href="online_batches.php">Online batches</a></li>
                                  <li><a href="free_workshop.php" class="active">Free Online Workshop Demo</a></li>
                                  <li><a href="#">Corporate Training</a></li>
                                  <li><a href="#">Weekends Training</a></li>
                              </ul>
                          </li>
  ...
  <section class="free-heading-page header-text" id="top">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <!-- <h6>Here are our upcoming meetings</h6> -->
          <h2>Free Online Workshop</h2>
        </div>
      </div>
    </div>
  </section>
